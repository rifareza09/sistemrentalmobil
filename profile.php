...
if(isset($_POST['updateprofile'])){
	$name=mysqli_real_escape_string($koneksidb, $_POST['fullname']);
	$mobileno=mysqli_real_escape_string($koneksidb, $_POST['mobilenumber']);
	$address=mysqli_real_escape_string($koneksidb, $_POST['address']);
...
<?php 
$useremail=mysqli_real_escape_string($koneksidb, $_SESSION['ulogin']);
